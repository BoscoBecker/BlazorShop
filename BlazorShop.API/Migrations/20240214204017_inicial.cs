    ...
    public partial class inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "fas fa-spa", "Sapatos" });

            migrationBuilder.InsertData(
                table: "Usuarios",
                columns: new[] { "Id", "NomeUsuario" },
                values: new object[] { 1, "Joao Bosco" });

            migrationBuilder.InsertData(
                table: "Produtos",
                columns: new[] { "Id", "CategoriaId", "Descricao", "ImageUrl", "Nome", "Preco", "Quantidade" },
                values: new object[] { 1, 1, "Um kit fornecido pela natureza, contendo proutos para cuidados com a pele", "", "Glossier -  Beleza Kit", 100m, 100 });
